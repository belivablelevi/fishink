...
const FISH = [
  // ── Common ──────────────────────────────────────────────────────
  { species: 'Progenetica', category: 'Common', value: 0.3, rarityWeight: 125, color: '#c8d0d0', sx:  0, sy: 0 },
  { species: 'European Anchovy', category: 'Common', value: 0.4, rarityWeight: 125, color: '#c8c8a0', sx: 11, sy: 5 },
  { species: 'Roule\'s Goby', category: 'Common', value: 0.5, rarityWeight: 115, color: '#7890a0', sx:  4, sy: 1 },
  { species: 'Guppy', category: 'Common', value: 0.5, rarityWeight: 115, color: '#f0a060', sx: 10, sy: 1 },
  { species: 'Zebrafish', category: 'Common', value: 0.5, rarityWeight: 115, color: '#3050a0', sx:  2, sy: 3 },
  { species: 'Petticoat Tetra', category: 'Common', value: 0.5, rarityWeight: 115, color: '#2040a0', sx:  3, sy: 3 },
  { species: 'Sailfin Molly', category: 'Common', value: 0.6, rarityWeight: 105, color: '#707890', sx: 11, sy: 1 },
  { species: 'Emperor Tetra', category: 'Common', value: 0.6, rarityWeight: 115, color: '#604880', sx:  1, sy: 3 },
  { species: 'Sardine', category: 'Common', value: 0.6, rarityWeight: 115, color: '#a0b8c0', sx: 10, sy: 3 },
  { species: 'Cardinal Tetra', category: 'Common', value: 0.7, rarityWeight: 115, color: '#e03020', sx:  0, sy: 3 },
  { species: 'Atlantic Herring', category: 'Common', value: 0.7, rarityWeight: 115, color: '#7a9ab8', sx: 11, sy: 3 },
  { species: 'Cherry Barb', category: 'Common', value: 0.7, rarityWeight: 105, color: '#c03030', sx:  8, sy: 4 },
  { species: 'Clownfish', category: 'Common', value: 0.8, rarityWeight: 115, color: '#e87030', sx:  1, sy: 0 },
  { species: 'Tiger Barb', category: 'Common', value: 0.8, rarityWeight: 105, color: '#e08020', sx:  7, sy: 4 },
  { species: 'Sea Cucumber', category: 'Common', value: 0.8, rarityWeight: 105, color: '#806040', sx:  0, sy: 11 },
  { species: 'Flying Fish', category: 'Common', value: 0.9, rarityWeight: 105, color: '#6080c0', sx:  9, sy: 1 },
  { species: 'Blue Tang', category: 'Common', value: 1.0, rarityWeight: 115, color: '#1870c8', sx:  2, sy: 0 },
  { species: 'Fighting Fish', category: 'Common', value: 1.0, rarityWeight: 95, color: '#9020c0', sx: 10, sy: 0 },
  { species: 'Perch', category: 'Common', value: 1.0, rarityWeight: 105, color: '#7a9a5a', sx:  4, sy: 3 },
  { species: 'Bartlett\'s Anthias', category: 'Common', value: 1.0, rarityWeight: 100, color: '#e06070', sx:  6, sy: 6 },
  { species: 'Blue Acara', category: 'Common', value: 1.0, rarityWeight: 95, color: '#3078b0', sx:  9, sy: 6 },
  { species: 'Dwarf Gourami', category: 'Common', value: 1.0, rarityWeight: 100, color: '#e06828', sx: 11, sy: 6 },
  { species: 'Hillstream Loach', category: 'Common', value: 1.0, rarityWeight: 100, color: '#806840', sx: 10, sy: 7 },
  { species: 'Mediterranean Mussel', category: 'Common', value: 1.0, rarityWeight: 105, color: '#504878', sx:  4, sy: 8 },
  { species: 'Sea Sponge', category: 'Common', value: 1.0, rarityWeight: 105, color: '#f0c030', sx:  6, sy: 9 },
  { species: 'Shrimp', category: 'Common', value: 1.0, rarityWeight: 105, color: '#f0a080', sx:  4, sy: 10 },
  { species: 'Yellow Tang', category: 'Common', value: 1.1, rarityWeight: 105, color: '#f0d020', sx:  3, sy: 0 },
  { species: 'Angelfish', category: 'Common', value: 1.2, rarityWeight: 95, color: '#b8c8c0', sx:  6, sy: 0 },
  { species: 'Goldfish', category: 'Common', value: 1.2, rarityWeight: 115, color: '#f0c030', sx:  9, sy: 0 },
  { species: 'Atlantic Trumpetfish', category: 'Common', value: 1.2, rarityWeight: 95, color: '#f0d070', sx:  5, sy: 6 },
  { species: 'Boeseman\'s Rainbowfish', category: 'Common', value: 1.2, rarityWeight: 100, color: '#e08030', sx:  9, sy: 7 },
  { species: 'Hard Clam', category: 'Common', value: 1.2, rarityWeight: 100, color: '#c0b8a0', sx:  2, sy: 8 },
  { species: 'Common Starfish', category: 'Common', value: 1.2, rarityWeight: 100, color: '#e04020', sx:  5, sy: 9 },
  { species: 'Fire Goby', category: 'Common', value: 1.3, rarityWeight: 95, color: '#e06010', sx:  7, sy: 6 },
  { species: 'Clown Loach', category: 'Common', value: 1.3, rarityWeight: 95, color: '#e06020', sx:  0, sy: 7 },
  { species: 'Catfish', category: 'Common', value: 1.5, rarityWeight: 85, color: '#7a6a5a', sx: 11, sy: 0 },
  { species: 'Garfish', category: 'Common', value: 1.5, rarityWeight: 95, color: '#60a860', sx:  9, sy: 3 },
  { species: 'Hake', category: 'Common', value: 1.5, rarityWeight: 90, color: '#909898', sx:  3, sy: 4 },
  { species: 'Common Barbel', category: 'Common', value: 1.5, rarityWeight: 95, color: '#907848', sx:  6, sy: 4 },
  { species: 'Rainbow Trout', category: 'Common', value: 1.5, rarityWeight: 95, color: '#c898d8', sx: 11, sy: 4 },
  { species: 'Raccoon Butterflyfish', category: 'Common', value: 1.5, rarityWeight: 95, color: '#f0c028', sx:  4, sy: 6 },
  { species: 'Oscar', category: 'Common', value: 1.5, rarityWeight: 95, color: '#c06818', sx: 10, sy: 6 },
  { species: 'Bluehead Wrasse', category: 'Common', value: 1.5, rarityWeight: 95, color: '#2060a0', sx:  7, sy: 7 },
  { species: 'Pacific Oyster', category: 'Common', value: 1.5, rarityWeight: 95, color: '#a0a8a0', sx:  0, sy: 8 },
  { species: 'Spiny Cockle', category: 'Common', value: 1.5, rarityWeight: 100, color: '#e0c090', sx:  6, sy: 8 },
  { species: 'Nomad Jellyfish', category: 'Common', value: 1.5, rarityWeight: 95, color: '#e08870', sx:  8, sy: 8 },
  { species: 'Moon Jelly', category: 'Common', value: 1.5, rarityWeight: 95, color: '#d0e8f0', sx: 10, sy: 8 },
  { species: 'Cushion Star', category: 'Common', value: 1.5, rarityWeight: 100, color: '#e07030', sx:  4, sy: 9 },
  { species: 'Hermit Crab', category: 'Common', value: 1.5, rarityWeight: 100, color: '#c88040', sx:  9, sy: 9 },
  { species: 'Goose Barnacle', category: 'Common', value: 1.5, rarityWeight: 95, color: '#a0b0b0', sx:  8, sy: 10 },
  { species: 'Tench', category: 'Common', value: 1.8, rarityWeight: 85, color: '#607840', sx:  9, sy: 2 },
  { species: 'Blackspot Seabream', category: 'Common', value: 1.8, rarityWeight: 90, color: '#a09880', sx:  0, sy: 4 },
  { species: 'Atlantic Spadefish', category: 'Common', value: 1.8, rarityWeight: 90, color: '#a8a8a8', sx:  8, sy: 6 },
  { species: 'Lumpfish', category: 'Common', value: 1.8, rarityWeight: 90, color: '#5880a0', sx:  8, sy: 7 },
  { species: 'Fried Egg Jellyfish', category: 'Common', value: 1.8, rarityWeight: 95, color: '#f0e060', sx:  7, sy: 8 },
  { species: 'Common Squid', category: 'Common', value: 1.8, rarityWeight: 95, color: '#9070b0', sx:  3, sy: 9 },
  { species: 'Common Carp', category: 'Common', value: 2.0, rarityWeight: 85, color: '#9a8a5a', sx:  8, sy: 2 },
  { species: 'Great Scallop', category: 'Common', value: 2.0, rarityWeight: 95, color: '#f0d0b0', sx:  5, sy: 8 },
  { species: 'Sea Urchin', category: 'Common', value: 2.0, rarityWeight: 95, color: '#202020', sx:  7, sy: 9 },
  { species: 'Blue Crab', category: 'Common', value: 2.0, rarityWeight: 95, color: '#3050c0', sx: 10, sy: 9 },
  { species: 'Atlantic Crayfish', category: 'Common', value: 2.0, rarityWeight: 90, color: '#c04020', sx:  1, sy: 10 },
  // ── Uncommon ────────────────────────────────────────────────────
