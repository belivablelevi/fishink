...
const BLOCK_DESCS = [
  ...
  "Processes fish in 2s. Best for Common & Uncommon fish (×1.6 value). Works on rarer fish but only adds ×1.1 — use a Smoker or Stamper for those. Fish enter from any belt side, exit from the front.",
  "Processes fish in 3.5s. Best for Uncommon & Rare fish (×2.4 value). Weak on Common fish (×1.2). Slower than the Washer but a much bigger boost for mid-tier catches. Fish enter from any belt side, exit from the front.",
  "Processes fish in 1.5s — the fastest machine. Best for Common fish only (×1.8 value). Nearly useless on Rare or above (×1.05). Great for high-volume common lines. Fish enter from any belt side, exit from the front.",
  "Processes fish in 4s. Best for Rare & Epic fish (×3.5 value) — the highest multiplier in the game. Weak on common fish (×1.3). Unlocks at $5,000 lifetime earned. Fish enter from any belt side, exit from the front.",
