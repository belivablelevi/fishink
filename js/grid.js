...
const BLOCK_DESCS = [
  "",
  "Catches fish automatically. Place a Belt next to it to carry fish away — no Belt means fish pile up and stop.",
  "Carries items one tile in the facing direction. R rotates. Chain: Fisher -> Belt -> [processor] -> Belt -> Seller.",
  "Input: Belt on any side. Cleans fish, raising sell value. Output: Belt on facing side.",
  "Input: Belt on any side. Smokes fish for a bigger value boost. Output: Belt on facing side.",
  "Input: Belt on any side. Flash-freezes fish for an even bigger boost. Output: Belt on facing side.",
  "Input: Belt on any side. Stamps fish with a quality seal for the final price bump. Output: Belt on facing side.",
  "Automatically sells fish that arrive via Belt. Place at the end of a Belt chain for passive income.",
  "Paved floor — every machine (except Fisher) must be placed on Concrete.",
  ...
  "Alternates output between straight-ahead and a turn, balancing two belt lines.",
  ...
  "Press E to link it to another Teleporter — fish that land on it are instantly relayed there, then exit in this block’s facing direction.",
];
